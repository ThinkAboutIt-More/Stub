    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [!loading && current && current.posterPath && (grad ? /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsx("div", {
          ...
          style: {
            background: `radial-gradient(ellipse 165% 85% at 72% -12%, ${grad.a} 0%, transparent 68%)`
          }
        }), /*#__PURE__*/_jsx("div", {
          className: "discover-grad",
          style: {
            background: `radial-gradient(ellipse 165% 90% at 22% 110%, ${grad.b} 0%, transparent 70%)`
          }
        }), /*#__PURE__*/_jsx("div", {
          className: "discover-grad discover-grad-wash",
          style: {
            background: `linear-gradient(180deg, ${grad.a} 0%, transparent 30%, transparent 70%, ${grad.b} 100%)`
          }
        })]
      }) : /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsx("div", {
